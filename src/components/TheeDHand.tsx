  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute top-1/2 left-1/2 z-50 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center text-center leading-[10px] md:leading-8">
        <span className="mb-3 font-sans text-[2.2vw] md:text-[1vw] tracking-widest text-foreground/50 uppercase">
          Full Stack Developer
        </span>

        <h1 className="mb-4 font-heading text-[5.5vw] md:text-[4vw] font-semibold uppercase text-primary leading-[10px] md:leading-5">
          I&apos;m Avinash <span className="inline-block"></span>
        </h1>

        <p className="max-w-xl font-sans text-[3.5vw] md:text-[1.7vw] font-medium text-foreground leading-[10px] md:leading-5">
          I Design. Build. Ship.
        </p>
      </div>
    </div>
