...
const Hero3 = () => {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col justify-center items-center bg-background text-foreground px-4 relative overflow-hidden transition-colors duration-300">
            <div className="flex flex-col items-center justify-center text-center w-full max-w-[800px] mx-auto z-10">
                ...
                <motion.div
                    ...
                    className={`flex items-center gap-2 mb-6 bg-foreground/[0.03] py-1 px-3 rounded-md border border-foreground/[0.08] transition-all duration-500 ${isAnyHovered ? 'opacity-20' : 'opacity-100'}`}
                >
                    <span className="relative flex h-2 w-2">
                        <span className={`animate-ping absolute inline-flex h-full w-full rounded-full transition-colors duration-500 ${isAnyHovered ? 'bg-foreground/20' : 'bg-primary opacity-75'}`}></span>
                        <span className={`relative inline-flex rounded-full h-2 w-2 transition-colors duration-500 ${isAnyHovered ? 'bg-foreground/20' : 'bg-primary'}`}></span>
                    </span>
                ...
                <motion.h1
                    ...
                    className={`font-erode text-[3.5rem] sm:text-[4.5rem] md:text-[5.5rem] lg:text-[6.4rem] font-[800] tracking-[-0.05em] leading-[0.9] mb-5 drop-shadow-sm transition-colors duration-500 ${isAnyHovered ? 'text-foreground/20' : 'text-foreground'}`}
                >
                    Avinash Kumar
                </motion.h1>
            ...
            {/* Buttons - Separated from the fading div */}
            <motion.div
            ...
            {/* Subtle bottom separator line similar to the screenshot */}
            <motion.div
